...
namespace TypedUnTypedDataSet.DataSet1TableAdapters {
...
SELECT ID, Name, Salary, DID FROM Employees WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TypedUnTypedDataSet.Properties.Settings.Default.EmployeeDBConnectionString;
        }
