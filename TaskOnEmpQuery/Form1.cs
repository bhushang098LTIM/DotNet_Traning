...
namespace task1
{
    public partial class frm_employee : Form
    {
        ...
        {
            InitializeComponent();
            strConnection = @"Data Source=PRSQL;User ID=labuser;Password=Welcome123$;Initial Catalog=EmployeeDB;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
            ...
            command.CommandText = "Select * from Depts";
        ...
        private void dgv_dept_row_header_clicked(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            cmdEmployee.CommandText = "select e.Name as EmployeeName,e.Salary as EmployeeSalary" +
                ", d.DeptName as DepartmentName from Employees e join Depts d on e.DID = d.DeptId where e.DID = " + selectedDepiID;
