...
namespace TypedUnTypedAndTwoTable.EmployeeDatasetTableAdapters {
...
SELECT ID, Name, Salary, DID FROM Employees WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TypedUnTypedAndTwoTable.Properties.Settings.Default.EmployeeDBConnectionString;
        }
