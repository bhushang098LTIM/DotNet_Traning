...
{
    internal class Sleepers : FootWear
    {
        ...
        public Sleepers(int size, bool type, string modelName, string companyName, float price)
        {
            this._size = size;
            this._type = type;
