<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Login_Redirection.Registration" %>
...
&nbsp;&nbsp;
            ...
            <br />
            <br />
            <asp:Label ID="lbl_validation1" runat="server" Text="validation Messahe"></asp:Label>
            <br />
        </div>
